	...
	<div class="app-content pt-3 p-md-3 p-lg-4">
		<div class="container-xl">
			...
			<nav id="orders-table-tab" class="orders-table-tab app-nav-tabs nav shadow-sm flex-column flex-sm-row mb-4">
				...
				<a class="flex-sm-fill text-sm-center nav-link" id="create_property_type-tab" data-bs-toggle="tab" href="#create_property_type" role="tab" aria-controls="orders-paid" aria-selected="false">បង្កើតថ្មី</a>
					...
					<div class="app-card app-card-orders-table mb-5">
						<div class="app-card-body">
							...
							if (isset($_POST['btn_save'])) {
								...
								$property_type_en = $_REQUEST['txt_property_type_en'];
								$property_type_dec = $_REQUEST['txt_property_type_dec'];
								$sql = "insert into tbl_property_type (property_type_kh,property_type_en,property_dec) 
								VALUES ('$property_type_kh','$property_type_en','$property_type_dec');";
								...
								<div class="app-card app-card-settings shadow-sm p-4">
									...
									<div class="app-card-body">
										<form class="settings-form" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
											<h1 class="app-page-title">បំពេញប្រភេទអចលនទ្រព្យ </h1>
											<div class="mb-3">
												<label for="txt_property_type_kh" class="form-label">ឈ្មោះប្រភេទអចលនទ្រព្យជាខ្មែរ <span style="color:red;">*</span>
											...
											<div class="mb-3">
												<label for="txt_property_type_en" class="form-label">ឈ្មោះប្រភេទអចលនទ្រព្យជាអង់គ្លេស<span style="color:red;">*</span>
												</label>
												<input type="text" name="txt_property_type_en" class="form-control" id="txt_property_type_en" value="" required>
											</div>
											<div class="mb-3">
											...
											<button type="submit" class="btn app-btn-primary" name="btn_save">រក្សាទុក</button>
										</form>
									</div><!--//app-card-body-->
